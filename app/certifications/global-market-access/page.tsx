...
export default function GlobalMarketAccessPage() {
  return (
    <div className="mx-auto max-w-7xl px-4 sm:px-6 py-10">
      ...
      />
      <h1 className="font-display text-4xl font-semibold text-ink-950 tracking-tight max-w-3xl">
        Global Market Access
      </h1>
      <p className="mt-4 text-lg text-ink-600 leading-relaxed max-w-3xl">
      ...
      <ol className="mt-10 grid gap-4 sm:grid-cols-2 max-w-4xl">
        {[
      ...
      <section className="mt-14 max-w-4xl">
        ...
        <ul className="mt-6 space-y-4">
          {HORIZONTAL_REGIMES.map((r) => (
            <li key={r.name} className="rounded-2xl border border-cream-300 bg-white px-5 py-4">
      ...
      <p className="mt-10 text-sm text-ink-500 max-w-3xl leading-relaxed">
